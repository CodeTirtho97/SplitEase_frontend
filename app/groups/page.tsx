...
//   const { groups, refreshGroups, friends, refreshFriends, loading: groupsLoading } = useGroups();
...
//       setNewMembers(group.members.filter((member: any) =>
...
//   const activeGroups = filteredAndSortedGroups().filter(group => !group.completed);
//   const completedGroups = filteredAndSortedGroups().filter(group => group.completed);
...
//                   <div className="p-2">
//                     <div className="font-medium text-gray-800 mb-2">Group Type</div>
//                     <select
//                       value={filterType}
...
//                   <div className="p-2">
//                     <div className="font-medium text-gray-800 mb-2">Sort By</div>
//                     <select
//                       value={sortBy}
...
//               <p className="text-sm text-center mt-1">Create a new group to get started!</p>
//               <Button
//                 text="Create Group"
//                 onClick={() => setIsModalOpen(true)}
...
//                         activityLevel === 'medium' ? 'bg-yellow-500' : 'bg-gray-300'
//                       }`}></div>
...
//                               activityLevel === 'medium' ? 'bg-yellow-500' : 'bg-gray-300'
//                             }`}></span>
//                             <span className="sr-only">{activityLevel} activity</span>
//                           </span>
//                         </div>
//                       </div>
//                     </div>
...
//                       <p className="line-clamp-2 mb-3">{group.description || "No description provided."}</p>
...
//                       {/* Activity indicator */}
//                       <div className={`w-1.5 self-stretch mr-4 ${
//                         activityLevel === 'high' ? 'bg-green-500' :
//                         activityLevel === 'medium' ? 'bg-yellow-500' : 'bg-gray-300'
//                       }`}></div>
...
//           {completedGroups.length === 0 ? (
//             <p className="text-gray-500 italic text-center py-4">No completed groups found.</p>
//           ) : viewMode === 'grid' ? (
...
//                     <p className="text-sm text-gray-500 line-clamp-2 mb-3">{group.description || "No description provided."}</p>
...
//                       <div className={`w-10 h-10 rounded-full flex items-center justify-center z-10 text-white font-semibold ${
//                         formStep >= 1 ? 'bg-indigo-500' : 'bg-indigo-200 text-gray-700'
//                       }`}>1</div>
//                       <div className="text-sm font-medium mt-2">Group Info</div>
//                     </div>
//                     <div className={`h-1 flex-1 ${formStep >= 2 ? 'bg-indigo-500' : 'bg-indigo-200'}`}></div>
//                     <div className="relative flex flex-col items-center flex-1">
//                       <div className={`w-10 h-10 rounded-full flex items-center justify-center z-10 font-semibold ${
//                         formStep >= 2 ? 'bg-indigo-500 text-white' : 'bg-indigo-200 text-gray-700'
//                       }`}>2</div>
//                       <div className="text-sm font-medium mt-2">Add Members</div>
//                     </div>
//                     <div className={`h-1 flex-1 ${formStep >= 3 ? 'bg-indigo-500' : 'bg-indigo-200'}`}></div>
//                     <div className="relative flex flex-col items-center flex-1">
//                       <div className={`w-10 h-10 rounded-full flex items-center justify-center z-10 font-semibold ${
//                         formStep >= 3 ? 'bg-indigo-500 text-white' : 'bg-indigo-200 text-gray-700'
//                       }`}>3</div>
...
//                               <button
//                                 onClick={() => setNewGroup({...newGroup, members: []})}
...
//                                 No members selected. Please add at least one member.
//                               </p>
//                             )}
//                           </div>
//                         </div>
...
//                             <p className="text-yellow-700">You don't have any friends added yet.</p>
//                             <button
...
//                         </div>
//                         <div>
//                           <h3 className="text-xl font-bold text-gray-800">{newGroup.name}</h3>
...
//                       <div>
//                         <h4 className="font-medium text-gray-700 mb-1">Members ({newGroup.members.length})</h4>
...
//                             </ul>
//                           ) : (
//                             <p className="text-red-600 text-sm">No members selected!</p>
//                           )}
//                         </div>
//                       </div>
//                     </div>
...
//                     <defs>
//                       <pattern id="triangles" width="60" height="60" patternUnits="userSpaceOnUse" patternTransform="scale(2)">
//                         <path d="M0,0 L30,52 L60,0 Z" fill="none" stroke="currentColor" strokeWidth="2"/>
//                       </pattern>
//                     </defs>
...
//                         <span className="text-gray-600 text-sm">{selectedGroup.members?.length || 0} members</span>
//                       </div>
//                       <div className="px-4 py-5 sm:p-6">
...
//                                    (typeof member === 'object' && typeof selectedGroup.createdBy === 'object' &&
...
//                     <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
//                       <div className="px-4 py-5 sm:px-6 bg-gray-50 border-b">
//                         <h3 className="text-lg font-medium text-gray-900">Who Owes Whom</h3>
//                       </div>
//                       <div className="px-4 py-5 sm:p-6">
//                         {owesList.length > 0 ? (
